...
class TabletFindPage extends StatefulWidget {
  const TabletFindPage({super.key});

  @override
  State<TabletFindPage> createState() => _TabletFindPageState();
}

const kGoogleApiKey = 'AIzaSyCMtEMbBqDdj3td0jpQb2x0nx4hBona7-s';

class _TabletFindPageState extends State<TabletFindPage> {
      ...
      body: Row(
        children: [
                  ...
                  child: Padding(
                    ...
                    child: Container(
                      ...
                      child: ConstrainedBox(
                        constraints:
                            const BoxConstraints(maxWidth: 400, maxHeight: 50),
                        child: Row(
          ...
          ConstrainedBox(
            ...
            child: Padding(
              padding: const EdgeInsets.all(8.0),
              child: EventsListView(isPage: false, events),
            ),
          )
        ],
      ),
